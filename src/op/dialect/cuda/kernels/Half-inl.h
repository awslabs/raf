 ...
 * See: https://github.com/pytorch/pytorch/blob/master/c10/util/Half-inl.h
 */

/*!
 * \file src/op/dialect/cuda/kernels/Half-inl.h
 * \brief Implementation of Half data type.
 */
...
inline C10_HOST_DEVICE Half operator/(const Half& a,
                                      const Half& b) __ubsan_ignore_float_divide_by_zero__ {
  return static_cast<float>(a) / static_cast<float>(b);
}
