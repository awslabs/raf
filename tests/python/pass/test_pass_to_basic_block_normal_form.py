...
def test_no_bind_diamond():
    ...
    def expected():
        ...
        z2 = relay.Call(mul_op, [x, c, null, null])
...
def test_if():
    def if_expr(x):
        ...
        v2 = relay.Call(equal_op, [x, two, null, null])
        true_branch = relay.Call(mul_op, [v1, two, null, null])
        false_branch = relay.Call(mul_op, [v1, one, null, null])
