...
def test_diamond():
    ...
    def expected():
        ...
        # define functions
        relu_call = mnm.ir.op.relu(x)
        abs_call = mnm.ir.op.abs(test_diamond_0_0)
        ...
        # make anf
        tanh_call = mnm.ir.op.tanh(a1)
        add_call = mnm.ir.op.add(a2, a3)
...
def test_tuple():
    ...
    def expected():
        ...
        # func1
        relu_call = mnm.ir.op.relu(x)
        abs_call1 = mnm.ir.op.abs(test_tuple1_0_0)
        ...
        concat_call = mnm.ir.op.concatenate(test_tuple2_0_1)
