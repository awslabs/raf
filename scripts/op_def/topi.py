...
OP_MAP = {
    ...
    "mnm.op.scatter": ["scatter", "relay.attrs.ScstterAttrs", "kOpaque"],
    ...
    "mnm.op.batch_matmul_nt": ["nn.batch_matmul", "", "kOpaque"],
    ...
    "mnm.op.adaptive_avg_pool2d": ["nn.adaptive_avg_pool2d", "", "kOpaque"],
    "mnm.op.adaptive_avg_pool2d_dx": ["nn.avg_pool2d_grad", "relay.attrs.MaxPool2DAttrs", "kOpaque"],
    "mnm.op.adaptive_max_pool2d": ["nn.adaptive_max_pool2d", "", "kOpaque"],
    "mnm.op.adaptive_max_pool2d_dx": ["nn.max_pool2d_grad", "relay.attrs.MaxPool2DAttrs", "kOpaque"],
