...
SCHEMAS = {
    ...
    "likes.h::resize": [
        ...
        Arg(name="method", 
            cxx_type="std::string",
            cxx_default="\"bilinear\"",
            py_default="\"bilinear\""),
        Arg(name="coordinate_transformation_mode", 
            cxx_type="std::string", 
            cxx_default="\"half_pixel\"",
            py_default="\"half_pixel\""),
        Arg(name="rounding_method",
            cxx_type="std::string",
            cxx_default="",
            py_default="\"\""),
        Arg(name="bicubic_alpha",
            cxx_type="float",
            cxx_default="-0.5",
            py_default="-0.5"),
        Arg(name="bicubic_exclude",
            cxx_type="int",
            cxx_default="0",
            py_default="0"),
        Arg(name="out_dtype", 
