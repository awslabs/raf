...
set(MNM_USE_CUDA OFF CACHE STRING "Build with CUDA")

# CUDA architecture. Option: 70(V100), 75(T4), 80(A100)
set(MNM_CUDA_ARCH 70 CACHE STRING "CUDA architure")

# MNM_USE_CUBLAS. Option: [ON/OFF]
set(MNM_USE_CUBLAS OFF CACHE STRING "Build with CuBLAS")

# MNM_USE_CUDNN. Option: [ON/OFF/Path-To-CUDNN]. You may use environment variables, like $ENV{CUDNN_HOME}
set(MNM_USE_CUDNN OFF CACHE STRING "Build with CuDNN")

# MNM_USE_SANITIZER. Option: [OFF/ASAN/MSAN/TSAN/UBSAN]"
set(MNM_USE_SANITIZER OFF)

# MNM_USE_MPI. Option: [ON/OFF]
set(MNM_USE_MPI OFF CACHE STRING "Build with MPI")

# MNM_USE_NCCL. Option: [ON/OFF]
set(MNM_USE_NCCL OFF CACHE STRING "Build with NCCL")

# MNM_USE_CUTLASS. Option: [ON/OFF].
set(MNM_USE_CUTLASS OFF CACHE STRING "Build with CUTLASS")
