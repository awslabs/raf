...
from .._core.context import Context
from .._core.value import TensorValue
from .._ffi._tvm import _DLManagedTensor, _register_func, tvm
...
def np_to_tensor_value(npa, ctx=None):
    ...
    if ctx is None:
        ...
        MarkNumpy(result._tensor, _manager_ctx(npa))
        return result
