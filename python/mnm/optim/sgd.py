...
from .._op.imp import sgd as imp_sgd
from .._op.sym import sgd as sym_sgd
...
class SGD:
    ...
    def step(self):
        ...
        for x0, v0 in self.params:
            if x0.grad is None:
                continue
            v1, x1 = imp_sgd(x0, x0.grad, v0, self._lr, self._momentum)
            x0.update(x1)
            v0.update(v1)
            ...
            def forward(self, dy, *args, **kwargs):
                ...
                for i, param in enumerate(inputs):
                    if param in self.params:
                        ...
                        ret = sym_sgd(x, dxi, v, self.learning_rate, self.momentum)
                        new_v = ret[0]
                        new_x = ret[1]
