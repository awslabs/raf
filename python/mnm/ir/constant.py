...
from mnm._core import ndarray as _nd
...
def to_value(value, dtype=None):
    ...
    Parameters
    ----------
    value: Union[bool, int, float, str, numpy.ndarray, mnm.nd.ndarray, list, tuple]
        The constant value.
...
def const(value, dtype=None):
    ...
    Parameters
    ----------
    value: Union[bool, int, float, str, numpy.ndarray, mnm.nd.ndarray, list, tuple, None]
