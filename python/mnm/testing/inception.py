...
class MNMInception3(mnm.Model):
    ...
    def build(self, num_classes=1000) -> None:
        ...
        self.Conv2d_2a_3x3 = MNMBasicConv2d(32, 32, kernel_size=3)
        self.Conv2d_2b_3x3 = MNMBasicConv2d(32, 64, kernel_size=3, padding=1)
        self.maxpool1 = MNMMaxPool2d(kernel=3, stride=2)
        self.Conv2d_3b_1x1 = MNMBasicConv2d(64, 80, kernel_size=1)
        self.Conv2d_4a_3x3 = MNMBasicConv2d(80, 192, kernel_size=3)
        self.maxpool2 = MNMMaxPool2d(kernel=3, stride=2)
        self.Mixed_5b = MNMInceptionA(192, pool_features=32)
        self.Mixed_5c = MNMInceptionA(256, pool_features=64)
        self.Mixed_5d = MNMInceptionA(288, pool_features=64)
        self.Mixed_6a = MNMInceptionB(288)
        self.Mixed_6b = MNMInceptionC(768, channels_7x7=128)
        self.Mixed_6c = MNMInceptionC(768, channels_7x7=160)
        self.Mixed_6d = MNMInceptionC(768, channels_7x7=160)
        self.Mixed_6e = MNMInceptionC(768, channels_7x7=192)
        self.Mixed_7a = MNMInceptionD(768)
        self.Mixed_7b = MNMInceptionE(1280)
        self.Mixed_7c = MNMInceptionE(2048)
        self.avgpool = MNMAdaptiveAvgPool2d((1, 1))
...
class MNMInceptionA(mnm.Model):
    def build(self, in_channels, pool_features):
        ...
        self.branch5x5_1 = MNMBasicConv2d(in_channels, 48, kernel_size=1)
        self.branch5x5_2 = MNMBasicConv2d(48, 64, kernel_size=5, padding=2)

        self.branch3x3dbl_1 = MNMBasicConv2d(in_channels, 64, kernel_size=1)
        self.branch3x3dbl_2 = MNMBasicConv2d(64, 96, kernel_size=3, padding=1)
        self.branch3x3dbl_3 = MNMBasicConv2d(96, 96, kernel_size=3, padding=1)

        self.avg_pool = MNMAvgPool2d(kernel=3, stride=1, padding=1)
        self.branch_pool = MNMBasicConv2d(in_channels, pool_features, kernel_size=1)
...
class MNMInceptionB(mnm.Model):
    def build(self, in_channels):
        ...
        self.branch3x3dbl_1 = MNMBasicConv2d(in_channels, 64, kernel_size=1)
        self.branch3x3dbl_2 = MNMBasicConv2d(64, 96, kernel_size=3, padding=1)
        self.branch3x3dbl_3 = MNMBasicConv2d(96, 96, kernel_size=3, stride=2)
        self.max_pool = MNMMaxPool2d(kernel=3, stride=2)
...
class MNMInceptionC(mnm.Model):
    def build(self, in_channels, channels_7x7):
        ...
        c7 = channels_7x7
        self.branch7x7_1 = MNMBasicConv2d(in_channels, c7, kernel_size=1)
        self.branch7x7_2 = MNMBasicConv2d(c7, c7, kernel_size=(1, 7), padding=(0, 3))
        self.branch7x7_3 = MNMBasicConv2d(c7, 192, kernel_size=(7, 1), padding=(3, 0))

        self.branch7x7dbl_1 = MNMBasicConv2d(in_channels, c7, kernel_size=1)
        self.branch7x7dbl_2 = MNMBasicConv2d(c7, c7, kernel_size=(7, 1), padding=(3, 0))
        self.branch7x7dbl_3 = MNMBasicConv2d(c7, c7, kernel_size=(1, 7), padding=(0, 3))
        self.branch7x7dbl_4 = MNMBasicConv2d(c7, c7, kernel_size=(7, 1), padding=(3, 0))
        self.branch7x7dbl_5 = MNMBasicConv2d(c7, 192, kernel_size=(1, 7), padding=(0, 3))

        self.avg_pool = MNMAvgPool2d(kernel=3, stride=1, padding=1)
        self.branch_pool = MNMBasicConv2d(in_channels, 192, kernel_size=1)
...
class MNMInceptionD(mnm.Model):
    def build(self, in_channels):
        ...
        self.branch7x7x3_1 = MNMBasicConv2d(in_channels, 192, kernel_size=1)
        self.branch7x7x3_2 = MNMBasicConv2d(192, 192, kernel_size=(1, 7), padding=(0, 3))
        self.branch7x7x3_3 = MNMBasicConv2d(192, 192, kernel_size=(7, 1), padding=(3, 0))
        self.branch7x7x3_4 = MNMBasicConv2d(192, 192, kernel_size=3, stride=2)
        self.max_pool = MNMMaxPool2d(kernel=3, stride=2)
...
class MNMInceptionE(mnm.Model):
    def build(self, in_channels):
        ...
        self.branch3x3_1 = MNMBasicConv2d(in_channels, 384, kernel_size=1)
        self.branch3x3_2a = MNMBasicConv2d(384, 384, kernel_size=(1, 3), padding=(0, 1))
        self.branch3x3_2b = MNMBasicConv2d(384, 384, kernel_size=(3, 1), padding=(1, 0))

        self.branch3x3dbl_1 = MNMBasicConv2d(in_channels, 448, kernel_size=1)
        self.branch3x3dbl_2 = MNMBasicConv2d(448, 384, kernel_size=3, padding=1)
        self.branch3x3dbl_3a = MNMBasicConv2d(384, 384, kernel_size=(1, 3), padding=(0, 1))
        self.branch3x3dbl_3b = MNMBasicConv2d(384, 384, kernel_size=(3, 1), padding=(1, 0))
    ...
    def forward(self, x):
        ...
        # branch3x3 = torch.cat(branch3x3, 1)
        branch3x3 = mnm.concatenate(branch3x3, 1)
        ...
        # branch3x3dbl = torch.cat(branch3x3dbl, 1)
        branch3x3dbl = mnm.concatenate(branch3x3dbl, 1)
...
class MNMInceptionBlock(mnm.Model):
...
class MNMAdaptiveAvgPool2d(mnm.Model):
    ...
    @mnm.model.trace
    def forward(self, x):
        return mnm.adaptive_avg_pool2d(x, self.shape, self.layout)


class MNMReLU(mnm.Model):
    def build(self):
        pass
