...
_reg.register_broadcast_schedule("mnm.op.equal")
_reg.register_broadcast_schedule("mnm.op.not_equal")
_reg.register_broadcast_schedule("mnm.op.less")
_reg.register_broadcast_schedule("mnm.op.less_equal")
_reg.register_broadcast_schedule("mnm.op.greater")
_reg.register_broadcast_schedule("mnm.op.greater_equal")
