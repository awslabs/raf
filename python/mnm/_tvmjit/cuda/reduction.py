# pylint: disable=invalid-name,unused-variable,too-many-locals,len-as-condition, missing-function-docstring, too-many-branches
"""Schedule for reduce operators, based on 3rdparty/tvm/python/tvm/topi/cuda/reduction.py"""
