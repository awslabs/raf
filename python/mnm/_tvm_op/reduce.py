...
_reg.register_reduce_schedule("mnm.op.tvm.max")
_reg.register_reduce_schedule("mnm.op.tvm.min")
_reg.register_reduce_schedule("mnm.op.tvm.all")
_reg.register_reduce_schedule("mnm.op.tvm.any")
