...
@register_compute("mnm.op.tvm.smooth_l1_loss")
...
_reg.register_injective_schedule("mnm.op.tvm.smooth_l1_loss")


@register_compute("mnm.op.tvm.smooth_l1_loss_dpred")
...
_reg.register_broadcast_schedule("mnm.op.tvm.smooth_l1_loss_dpred")


@register_compute("mnm.op.tvm.smooth_l1_loss_dtrue")
...
_reg.register_broadcast_schedule("mnm.op.tvm.smooth_l1_loss_dtrue")


@register_compute("mnm.op.tvm.nll_loss")
...
_reg.register_injective_schedule("mnm.op.tvm.nll_loss")


@register_compute("mnm.op.tvm.nll_loss_dpred")
...
_reg.register_broadcast_schedule("mnm.op.tvm.nll_loss_dpred")


@register_compute("mnm.op.tvm.nll_loss_dtrue")
...
_reg.register_broadcast_schedule("mnm.op.tvm.nll_loss_dtrue")


@register_compute("mnm.op.tvm.cross_entropy")
...
_reg.register_broadcast_schedule("mnm.op.tvm.cross_entropy")


@register_compute("mnm.op.tvm.cross_entropy_dpred")
...
_reg.register_broadcast_schedule("mnm.op.tvm.cross_entropy_dpred")


@register_compute("mnm.op.tvm.cross_entropy_dtrue")
...
_reg.register_broadcast_schedule("mnm.op.tvm.cross_entropy_dtrue")
