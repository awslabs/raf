...
_reg.register_injective_schedule("mnm.op.tvm.pad")
...
_reg.register_injective_schedule("mnm.op.tvm.batch_matmul_tt")

_reg.register_strategy("mnm.op.tvm.batch_matmul_nt", strategy.batch_matmul_strategy)
...
_reg.register_schedule("mnm.op.tvm.avg_pool2d", strategy.schedule_pool)
# TODO(@XIAO-XIA): cuda schedule should be complemented after the implementation of auto schedule

_reg.register_schedule("mnm.op.tvm.avg_pool2d_dx", strategy.schedule_pool_grad)

_reg.register_schedule("mnm.op.tvm.max_pool2d", strategy.schedule_pool)
# TODO(@XIAO-XIA): cuda schedule should be complemented after the implementation of auto schedule

_reg.register_schedule("mnm.op.tvm.max_pool2d_dx", strategy.schedule_pool_grad)

_reg.register_schedule("mnm.op.tvm.adaptive_avg_pool2d", strategy.schedule_adaptive_pool)
_reg.register_schedule("mnm.op.tvm.adaptive_avg_pool2d_dx", strategy.schedule_pool_grad)
...
@register_compute("mnm.op.tvm.conv2d_dw")
...
_reg.register_schedule("mnm.op.tvm.conv2d_dw", schedule_generic)


@register_compute("mnm.op.tvm.conv2d_transpose_dx")
